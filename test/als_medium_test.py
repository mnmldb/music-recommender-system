...
if __name__ == "__main__":
    ...
    # read file
    path_train_use = path_train_medium
    ...
    # union
    df_all_stg = df_train_raw.union(df_val_raw)
    df_all = df_all_stg.union(df_test_raw)
    ...
    # modeling
    als = ALS(rank=20, maxIter=20, regParam=0.01, alpha=2, implicitPrefs=True, userCol='userIndex', itemCol='trackIndex', ratingCol='count', coldStartStrategy="drop")
